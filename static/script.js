document.addEventListener("DOMContentLoaded", async() => {
    ...
    // Remove BASE_URL definition as it's not needed with relative paths
    ...
    window.uploadImage = async () => {
        ...
        try {
            ...
            const response = await fetch('/predict-cuisine', {
                method: 'POST',
                body: formData
            });
    ...
    async function fetchRestaurants() {
        try {
            ...
            const response = await fetch(`/restaurants?${params.toString()}`);
            ...
            card.innerHTML = `
                <div class="restaurant-info">
                    <img class="restaurant-image" 
                         src="${restaurant.thumb || '/static/placeholder.jpg'}" 
                         alt="${restaurant.name}"
